...
@section('content')
  ...
  <div class="table-responsive col-lg-12">
    ...
    <div class="d-sm-flex align-items-center justify-content-between align-items-center my-4">
      <h1 class="h3 mb-0 text-gray-800 clrT">Hasil Pembobotan</h1>
    </div>
      ...
      <thead>
        <tr>
          ...
          @foreach ($criteria_analysis->preventiveValues as $preventValue)
            <th scope="col" class="text-center clrT">{{ $preventValue->criteria->name }}</th>
          @endforeach
          <th scope="col" class="text-center clrT bg-secondary text-white">Nilai Hasil</th>
        </tr>
      </thead>
      <tbody class="clrT">
        @php($startAt = 0)
    ...
    <div class="d-sm-flex align-items-center justify-content-between align-items-center my-4">
      <h1 class="h3 mb-0 text-gray-800">Hasil CI RI dan Konsisten</h1>
    </div>
      ...
      <thead class="clrT">
        <tr>
          ...
          @foreach ($criteria_analysis->preventiveValues as $preventValue)
            <th scope="col" class="text-center clrT">{{ $preventValue->criteria->name }}</th>
          @endforeach
          <th scope="col" class="text-center clrT bg-secondary text-white">Jumlah Baris</th>
        </tr>
      </thead>
      <tbody class="clrT">
        @php($startAt = 0)
