...
class RankC extends Controller
{
  public function index()
  {
    ...
    return view('pages.dashboard.rank.index', [
      'title'             => 'Final Ranking',
  ...
  public function show(CriteriaAnalysis $criteriaAnalysis)
  {
    ...
    $alternatives   = Alternatif::getAlternativesByCriteria($criteriaIds);
    $dividers       = Alternatif::getDividerByCriteria($criterias);
    ...
    return view('pages.dashboard.rank.rank', [
      'title'        => 'Final Ranking',
      'dividers'     => $dividers,
  ...
  private function _countNormalization($dividers, $alternatives)
  {
    ...
    foreach ($alternatives as $alternative) {
      ...
      array_push($normalization, [
        'aktifitas_object_id' => $alternative['aktifitas_object_id'],
        'aktifitas_name' => $alternative['aktifitas_name'],
